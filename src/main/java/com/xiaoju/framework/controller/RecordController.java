...
public class RecordController {
    ...
    public Response<Long> createRecord(@RequestBody RecordAddReq req) {
        ...
        try {
            ...
            Log.error("[新增record出错]入参={}, 原因={}", req.toString(), e.getMessage());
            e.printStackTrace();
    ...
    public Response<?> editRecord(@RequestBody RecordUpdateReq req) {
        ...
        try {
            ...
            Log.error("[列表页面-更新record属性出错]入参={}, 原因={}", req.toString(), e.getMessage());
            e.printStackTrace();
            return Response.build(StatusCode.SERVER_BUSY_ERROR);
        }
    }
    ...
    public Response<?> deleteRecord(@RequestBody RecordDeleteReq req) {
        ...
        try {
            ...
            Log.error("[删除record错误]入参={}, 原因={}", req.toString(), e.getMessage());
            e.printStackTrace();
            return Response.build(StatusCode.SERVER_BUSY_ERROR);
        }
    }
    ...
    public Response<?> clearRecord(@RequestBody RecordWsClearReq req) {
        ...
        try {
            ...
            Log.error("[协同页面-清除record执行记录出错]入参={}, 原因={}", req.toString(), e.getMessage());
            e.printStackTrace();
            return Response.build(StatusCode.SERVER_BUSY_ERROR);
        }
    }
