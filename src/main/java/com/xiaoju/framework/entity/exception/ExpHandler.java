...
public class ExpHandler {
        ...
        public Response<?> handlerException(IllegalArgumentException e) {
                e.printStackTrace();
                Log.error(StatusCode.INTERNAL_ERROR.getCode(), e.getMessage());
        ...
        public Response<?> handlerException(JsonMappingException e) {
                e.printStackTrace();
                Log.error(StatusCode.JSON_FORMAT_ERROR.getCode(), e.getMessage());
        ...
        public Response<?> handlerException(JsonParseException e) {
                e.printStackTrace();
                Log.error(StatusCode.DATA_FORMAT_ERROR.getCode(), e.getMessage());
        ...
        public Response<?> handlerException(Exception e) {
                e.printStackTrace();
                Log.error(StatusCode.SERVER_BUSY_ERROR.getCode(), e.getMessage());
