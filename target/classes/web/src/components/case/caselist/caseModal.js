  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Form.Item style={{ display: 'inline-flex', marginLeft: '83px', marginTop: '-5px' }} label="关联需求：" required>
          <Form.Item
            style={{ display: 'inline-block', width: '100px' }}
            name="jiar"
          >
            {getFieldDecorator('jiar', {
              rules: [{ required: true, message: '请填写JIRA编号' }],
              initialValue: data ? data.requirementId.split(" ")[0] : undefined,
            })(
              <Input placeholder="JIRA编号" />
            )}
          </Form.Item>
          <Form.Item
            style={{ display: 'inline-block', width: '325px', marginLeft: '10px' }}
            name="requirementId"
          >
            {getFieldDecorator('requirementId', {
              rules: [{ required: true, message: '请填写JIRA关联需求名称' }],
              initialValue: data ? data.requirementId.split(" ")[1] : undefined,
            })(
              <Input placeholder="JIRA关联需求名称" />
            )}
          </Form.Item>
        </Form.Item>
